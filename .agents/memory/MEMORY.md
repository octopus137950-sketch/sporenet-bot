...
- [Termux bundle verification](termux-bundle-verification.md) — after pulling source changes, rebuild and inspect dist before restarting because Termux runs the ignored bundle.
- [Discord.js interaction typing](discordjs-interaction-typing.md) — visibility belongs on initial replies; current typings reject ephemeral edit replies and delete reasons.
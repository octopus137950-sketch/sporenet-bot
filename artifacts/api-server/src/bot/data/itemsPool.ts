...
export const ADMIN_ONLY_ITEMS: BuffItem[] = [
  {
    ...
    lore: "⚠️ [ไอเทมพิเศษจากแอดมิน] เพิ่มพลังโจมตี +999,999,999%",
    buffType: "attack_percent",

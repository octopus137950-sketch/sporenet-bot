    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          "→ สร้างยศความสำเร็จใหม่ พร้อมเลือกเงื่อนไขจากเมนู ใส่เป้าหมาย รางวัลสปอร์ และเลือกยศ Discord จากรายการในเซิร์ฟเวอร์",
          "  • `condition1_type/value` — เงื่อนไขข้อที่ 1 (จำเป็น)",
          "  • `condition2_type/value` และ `condition3_type/value` — เงื่อนไขเพิ่มเติม (ไม่บังคับ)",
          "  • ประเภท: ข้อความ / ฟาร์ม / เวลาในห้องเสียง / เควสสำเร็จ",
          "✏️ ตัวอย่าง: สร้างยศ 'นักพูดแห่งอาณาจักร' สำหรับคนที่ส่งข้อความครบตามเป้าหมาย\n",
          "**`/achievement-admin edit <id>`** — แก้ไขยศ เลือกเงื่อนไขใหม่หรือเลือกยศ Discord ใหม่ได้\n",

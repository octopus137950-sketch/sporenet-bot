    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          "`/worldmushroom` — ดูเลเวลเห็ดโลก บัฟ และอันดับผู้บริจาค",
          "`/water amount:<จำนวน>` — บริจาคสปอร์ให้เห็ดโลกเพื่อเพิ่ม EXP",
          "`/protect` — ป้องกันเห็ดโลกเมื่อศัตรูพืชบุก",
          ...
          "`/market-sell` — ลงขายไอเทมในห้องตลาดกลางที่แอดมินตั้งค่าไว้",
          "`/market-history` — ดูประวัติการซื้อขายไอเทมของตัวเอง",
        ].join("\n"),
        inline: false,
      },
      {
      ...
      },
      {
        ...
        value: [
          ...
          "**ตลาดกลางผู้เล่น 🛒** — เลื่อนดูประกาศในห้องตลาดและกดปุ่มซื้อได้ทันที",
        ].join("\n"),
        inline: false,
      },
      {
